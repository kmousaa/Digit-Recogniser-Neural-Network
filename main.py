...
image_number = 0
while os.path.exists(f"handwriten_numbers/handwritten{image_number}.png"):  # Check if the file exists
    try:
        img = cv2.imread(f"handwriten_numbers/handwritten{image_number}.png")[:, :, 0]  # Read the file, we only care about shape
